...
class EtBondHoldingDescriptionPage extends StatefulWidget {
  final String idToken;
  final String pdno;
  final int idCode;
  const EtBondHoldingDescriptionPage({super.key, required this.pdno, required this.idToken, required this.idCode});

  @override
  _EtBondHoldingDescriptionPageState createState() => _EtBondHoldingDescriptionPageState();
}

class _EtBondHoldingDescriptionPageState extends State<EtBondHoldingDescriptionPage> {
                          ...
                          children: [
                            ...
                            ? 18 : MediaQuery.of(context).size.height * 0.018, fontWeight: FontWeight.bold, color: Colors.black)
                                ...
                                if (confirmed == true) {
                                  ...
                                  try {
                                    await dio.delete(
                                      'http://localhost:8000/api/marketbond/holding/${widget.idCode}/',
                                      options: Options(
                                        headers: {
