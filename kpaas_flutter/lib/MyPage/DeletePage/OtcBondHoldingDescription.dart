...
class OtcBondHoldingDescriptionPage extends StatefulWidget {
  final Map<String, dynamic> bondData;
  final String idToken;
  final int idCode;
  const OtcBondHoldingDescriptionPage({Key? key, required this.bondData, required this.idToken, required this.idCode}) : super(key: key);


  @override
  _OtcBondHoldingDescriptionPageState createState() => _OtcBondHoldingDescriptionPageState();
}

class _OtcBondHoldingDescriptionPageState extends State<OtcBondHoldingDescriptionPage> {
  // 선택 상태 관리 변수
                          ...
                          children: [
                            ...
                            ? 18 : MediaQuery.of(context).size.height * 0.018, fontWeight: FontWeight.bold, color: Colors.black)
                                ...
                                if (confirmed == true) {
                                  ...
                                  try {
                                    await dio.delete(
                                      'http://localhost:8000/api/otcbond/holding/${widget.idCode}/',
                                      options: Options(
                                        headers: {
