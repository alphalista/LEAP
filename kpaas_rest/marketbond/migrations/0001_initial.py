# Generated by Django 5.1.1 on 2024-11-05 17:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('code',), name='unique_code_field')],
            },
        ),
        migrations.CreateModel(
            name='ClickCount',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketbond.marketbondcode')),
                ('inquire_asking_price_data', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketbond.marketbondinquireaskingprice')),
                ('inquire_price_data', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketbond.marketbondinquireprice')),
                ('issue_info_data', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketbond.marketbondissueinfo')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ksd_int_calc_unit_cd', models.CharField(choices=[('1', '발행금액'), ('2', '만원'), ('3', '십만원'), ('4', '백만원')], max_length=1, verbose_name='증권예탁결제원이자계산단위코드')),
                ...
                ('expd_rdpt_rt', models.CharField(max_length=238, verbose_name='만기상환율')),
                ('expd_asrc_erng_rt', models.CharField(max_length=238, verbose_name='만기보장수익율')),
                ('bond_int_dfrm_mthd_cd', models.CharField(choices=[('01', '할인채'), ('02', '복리채'), ('03', '이표채.확정금리'), ('04', '이표채.금리연동'), ('05', '이표채.변동금리'), ('06', '단리채'), ('07', '분할채'), ('09', '복5단2'), ('19', '기타.고정금리'), ('29', '기타.변동금리')], max_length=2, verbose_name='채권이자지급방법코드')),
                ('int_dfrm_day_type_cd', models.CharField(choices=[('01', '발행일'), ('02', '만기일'), ('03', '특정일')], max_length=2, verbose_name='이자지급일유형코드')),
                ('prca_dfmt_term_mcnt', models.CharField(max_length=6, verbose_name='원금거치기간개월수')),
                ('splt_rdpt_rcnt', models.CharField(max_length=6, verbose_name='분할상환횟수')),
                ('rgbf_int_dfrm_dt', models.CharField(max_length=8, verbose_name='직전이자지급일자')),
                ('nxtm_int_dfrm_dt', models.CharField(max_length=8, verbose_name='차기이자지급일자')),
                ...
                ('bond_clsf_cd', models.CharField(max_length=6, verbose_name='채권분류코드')),
                ('bond_clsf_kor_name', models.CharField(max_length=60, verbose_name='채권분류한글명')),
                ('int_mned_dvsn_cd', models.CharField(choices=[('0', '확인불가'), ('1', '일자기준'), ('2', '말일기준')], max_length=1, verbose_name='이자월말구분코드')),
                ('pnia_int_calc_unpr', models.CharField(max_length=234, verbose_name='원리금이자계산단가')),
                ...
                ('expd_dydv_calc_dcnt', models.CharField(max_length=9, verbose_name='만기일할계산일수')),
                ...
                ('ksd_indf_frqc_uder_calc_dcnt', models.CharField(max_length=5, verbose_name='증권예탁결제원이자지급주기미만')),
                ('tlg_rcvg_dtl_dtime', models.CharField(max_length=10, verbose_name='전문수신상세일시')),
                ('code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketbond.marketbondcode')),
            ],
        ),
