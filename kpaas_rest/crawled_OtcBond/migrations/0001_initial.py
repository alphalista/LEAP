# Generated by Django 5.1.1 on 2024-11-07 00:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expired_bonds', to='crawled_OtcBond.users')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='holding_bonds', to='crawled_OtcBond.users')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crawled_OtcBond.users')),
            ],
            options={
                'unique_together': {('user_id', 'bond_code')},
            },
